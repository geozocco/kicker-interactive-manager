...
Bei **geringem Betreuungsaufwand** konzentriert das Plugin unabhängig vom Strategieprofil mindestens 70 Prozent des Budgets auf einen starken Aufstellungskern. Die Bank wird günstiger, aber mit realistischen Einsatzchancen besetzt. Der Kern enthält mindestens zwei Stürmer und höchstens vier Verteidiger; ein Torwartblock muss den anhand von Einsatz-, Rollen- und Talentdaten erwarteten Stammtorhüter enthalten. Im Profil **verlässlich** kommen mindestens vier bestätigte Leistungsträger hinzu. Im Ergebnis erklärt Codex die wichtigsten Spieler einzeln und vergleicht bewusst ausgelassene etablierte Alternativen samt Budget- und Risikogründen.
