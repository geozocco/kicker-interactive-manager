...
Sobald kicker den offiziellen Spieler-Daten-Export veröffentlicht hat, kann Codex einen Bundesliga-Kader bereits read-only planen, bewerten und in Varianten vergleichen. Käufe und Verkäufe im geöffneten Chrome-Tab sind erst möglich, nachdem kicker den Transfermarkt freigeschaltet hat. Bis dahin soll Codex keine andere Liga auswählen. Die Weltmeisterschaft wird von diesem Plugin nicht unterstützt.
...
Bei **geringem Betreuungsaufwand** verwendet das Plugin zuerst das vollständige Budget und konzentriert danach so viel Kaderwert wie sinnvoll auf einen starken Aufstellungskern. Mindestens 55 Prozent des Kaderwerts müssen in der stärksten Elf liegen; ein höherer Anteil bleibt das Ziel, darf aber niemals durch verschenktes Budget erkauft werden. Die Bank bleibt einsatzfähig und erhält sinnvolle Qualitäts-Upgrades, sobald der Kern finanziert ist. Reserveplätze werden dabei nach ihrer realistischen Nutzung abnehmend gewichtet: Ein erster Vertreter ist wertvoller als der zweite oder dritte zusätzliche Spieler derselben Position. Im wartungsarmen Profil sollen mindestens 80 Prozent des Mittelfeldbudgets in den tatsächlich aufgestellten Spielern und mindestens 75 Prozent des Sturm-Budgets in den höchstens drei gleichzeitig aufstellbaren Angreifern liegen. Außerhalb der Startelf wird höchstens ein gewöhnlicher Mittelfeldspieler oberhalb des Mindestpreises finanziert; ein zusätzlicher teurerer Reserveplatz muss ein qualifizierter Potenzialspieler sein. In der Abwehr ist dagegen ein wirklich spielbarer erster Ersatz Pflicht. Danach dürfen bei Dreierkette höchstens drei und bei Viererkette höchstens zwei reine Mindestpreisfüller verbleiben; ein nachweislich einsatzreifer Mindestpreisspieler zählt nicht als Füller. Zusätzlich wird mindestens ein offensiver Premiumstarter aus der höchsten aktuellen Preisstufe angestrebt – jedoch nur, wenn seine Modellleistung zugleich zum oberen Viertel seiner Position gehört; der Preis allein erzeugt keinen Bonus. Ein günstigerer **Elite-Rebound-Stürmer** kann dieselbe Premiumsuche erreichen, wenn mindestens vier bestätigte Spielzeiten, ein außergewöhnlicher historischer Torpfad, eine einzelne deutlich schwächere letzte Saison sowie aktuell mindestens 75 Prozent Startwahrscheinlichkeit und wiederhergestellte Fitness belegt sind. Dann begrenzt das Modell den Recency-Abschlag und prüft ausdrücklich, ob teure vierte/fünfte Stürmer oder Mittelfeldreserven seine Finanzierung ermöglichen. Der Kern enthält mindestens zwei Stürmer und höchstens vier Verteidiger. Im Tor reicht ein vollständiger Vereinsblock nicht: Die erwartete Nummer eins muss mindestens 70 Prozent Saison-Stammplatzwahrscheinlichkeit, höchstens 40 Prozent Risiko eines noch kommenden externen Stammkeepers und mindestens mittlere Hierarchiesicherheit erreichen. Im Profil **verlässlich** kommen mindestens vier bestätigte Leistungsträger sowie mindestens ein mehrjährig bestätigter offensiver Premiumanker in der Startelf hinzu. Für diesen Status genügt ein sicherer Stammplatz nicht: Zusätzlich muss ein belastbarer Scorerpfad aus wiederholbarer Tor-/Vorlagenproduktion, Standards, Spielmacher- oder offensiver Fokusrolle vorliegen. Ein verlässlicher, offensiv unauffälliger Spieler kann weiter ausgewählt werden, wird aber nicht als offensiver Ausnahmespieler geschützt. Namen aus früheren Gesprächen spielen dabei keine Rolle. Im Ergebnis erklärt Codex die wichtigsten Spieler einzeln und vergleicht bewusst ausgelassene etablierte Alternativen samt Budget- und Risikogründen.

Junge Spieler erhalten dabei eine echte, aber keine erzwungene Chance: Zwei qualifizierte U23-Spieler im erweiterten Kern sind ein weiches Ziel. Für einen Startelfplatz muss ein Talent höchstens sieben Prozent beziehungsweise sieben Modellpunkte hinter einer ähnlich teuren Positionsalternative liegen. Umgekehrt schützt ein berühmter Name nicht vor einem Formabschlag. Bei Spielern ab 30 begrenzt das Modell historische Boni, wenn die letzten zwei belastbaren Spielzeiten klar unter dem älteren Niveau liegen; ein belegter Verletzungs- oder Rückkehrfall bleibt davon ausgenommen. Kapitänsamt, Vertragsverlängerung oder ein einzelner Testspielstart reichen außerdem nicht mehr für eine sehr hohe Startprognose. Bezahlte Feldspieler auf der Bank müssen eine aktuelle Einsatzrolle, einen qualitätsnahen Potenzialpfad oder einen messbaren Formationsnutzen nachweisen.

Zusätzlich verhindert ein hartes Budget-Gate eine zweite teure Abwehr: Neben dem ersten direkt einsetzbaren Vertreter darf nur ein weiterer bezahlter Abwehrreservist stehen, und dieser muss als qualifizierter Potenzialspieler belegt sein. Das Premiumstarter-Gate verlangt jetzt außerdem einen echten mehrjährig bestätigten Topscorer aus der oberen Preis- und Leistungsgruppe; ein hoher Preis oder reine Spielmacherqualität ohne starken Tor-/Scorerpfad reicht nicht.
...
Das Plugin würfelt dann kontrolliert neu und erklärt die Unterschiede. Dafür merkt es sich ausschließlich lokal die Spieler-IDs der höchstens fünf zuletzt abgeschlossenen Varianten desselben Liga- und Strategiekontexts. Häufig wiederholte gewöhnliche Spieler erhalten innerhalb des engen Qualitätskorridors eine zunehmende Wiederholungsstrafe; bewährte, nicht gleichwertig ersetzbare Ausnahmespieler dürfen trotzdem in mehreren Kadern vorkommen. Dieselbe Variantengeneration bleibt reproduzierbar. Eine garantierte weltweite Einzigartigkeit gibt es ohne zentralen Kaderspeicher nicht, zufällige Überschneidungen bleiben also möglich. Ein namentlich erwähnter Spieler wird nur recherchiert und verglichen; er erhält dadurch keinen Bonus und wird nur auf ausdrücklichen Wunsch zwingend gekauft.
...
Vor dem Umbau prüft das Plugin außerdem aktuelle Verletzungs- und Transfermeldungen. Für Bundesliga, 2. Bundesliga und 3. Liga der Saison 2026/27 verwendet das Plugin automatisch den zentralen API-Sports-Feed dieses Projekts. Sportmonks ist als optionale unabhängige Gegenquelle vorbereitet und wird automatisch mitverwendet, sobald zentral ein Token und geprüfte Spielerzuordnungen eingerichtet sind. Zusätzlich ergänzt ein zentral gepflegter redaktioneller Belegkanal aktuelle Vereins-, Liga-, kicker-, Sky- und Transfermarkt-Meldungen. Kritische Nulltreffer werden unabhängig ein zweites Mal gesucht; fortgeschrittene Abgangsmeldungen und unklare kritische Fälle sperren die Endauswahl und lösen eine Neuoptimierung aus. Der finale News-Gate prüft alle 22 Spieler. Dafür müssen Kollegen weder einen API-Key noch eine Feed-Adresse einrichten. Der Feed wird viermal täglich aktualisiert und enthält nur normalisierte Spieler-, Verletzungs- und Transferdaten; die geheimen Provider-Schlüssel bleiben im geschützten GitHub-Secret-Speicher.
...
Auch hierfür brauchen Kollegen keinen eigenen Schlüssel. Der OpenAI-Key liegt nur als geschütztes GitHub-Secret vor. Rollenprofile und das neutrale Ergebnis „kein belastbarer aktueller Beleg“ werden risikogestaffelt zentral zwischengespeichert und nur bei Ablauf, einer Kaderänderung oder offenen Fragen neu recherchiert. Die vier täglichen Läufe sind günstige Dringlichkeitsläufe: Sie prüfen nur neue Identitäten, echte aktuelle Transfergefahr, offene Torwarthierarchien oder andere besonders riskante Fälle. Ein Standardlauf kontrolliert einmal pro Woche den breiteren Markt; manuell bleibt er jederzeit möglich. Ein Spieler fehlt nicht deshalb „kritisch“, weil er außerhalb des bewusst kompakten Qualitätsbestands liegt, und ein bereits vollzogener Zugang mit niedrigem Restrisiko löst keine neue Websuche aus. Die statischen GPT-5.6-Anweisungen verwenden explizites Prompt-Caching; Token-, Cache- und Web-Search-Kosten werden im zentralen Snapshot ausgewiesen. Das hält Aufstellung und Kaderbewertung schnell und vermeidet unnötige API-Kosten.
