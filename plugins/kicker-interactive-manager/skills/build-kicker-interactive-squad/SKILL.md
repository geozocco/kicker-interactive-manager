...
- Das `squad_architecture`-Audit prüfen: Modellversion, erwarteten rollenbereinigten Beitrag, Preisobergrenze, tatsächlich im Suchraum erreichbares Kernziel, gewählte Kernquote, Qualitätskorridor und Zahl geprüfter kostenneutraler Kader nennen. Das theoretische Preismaximum niemals als garantiert erreichbares sportliches Ziel ausgeben.
