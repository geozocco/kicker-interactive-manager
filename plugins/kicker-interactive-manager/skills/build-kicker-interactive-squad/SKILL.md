...
Die Kombination `verlässlich` und `gering` ist das konservative Kollegenprofil: Der Kader soll über einen möglichst sicheren, hochwertigen Kern funktionieren. Die Bank fängt einzelne Ausfälle mit günstigen Spielern ab, die realistische Einsatzminuten haben; sie muss den Kern weder preislich noch leistungsmäßig spiegeln. Ein geringer Betreuungsaufwand konzentriert aber in jedem Strategieprofil mindestens 70 Prozent des Budgets auf die stärkste Elf, verlangt dort mindestens zwei Stürmer sowie höchstens vier Verteidiger und nimmt im Torwartblock stets den datenbasiert erwarteten Stammtorhüter mit.
...
- Für `gering` müssen mindestens 70 Prozent des gesamten Kaderwerts in der stärksten legalen Startelf liegen. Diese enthält mindestens zwei Stürmer, höchstens vier Verteidiger und den datenbasiert erwarteten Stammtorhüter des Torwartblocks. Ein niedrigerer Wert ist ein Abbruchgrund: Bank verbilligen, nachgewiesene Scorer und Kreativspieler finanzieren und neu rechnen.
