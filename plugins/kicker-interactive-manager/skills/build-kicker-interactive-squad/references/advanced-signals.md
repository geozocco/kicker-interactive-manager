...
- `usage_trajectory`: Chronologische Vorbereitungseinsätze und verfügbare aktuelle Pflichtspiele in frühe und jüngste Einsatzanteile teilen. Mindestens zwei Beobachtungen für `rising` oder `falling` verlangen.
