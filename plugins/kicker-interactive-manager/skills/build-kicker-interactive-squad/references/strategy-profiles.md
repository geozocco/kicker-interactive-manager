...
- Das vollständige Budget muss zuerst verwendet werden. Danach müssen unabhängig vom Strategieprofil mindestens 55 Prozent des Kaderwerts in der stärksten legalen Startelf liegen. Für `gering` liegt das Ziel bei 80 Prozent, wird aber auf die aus den aktuellen Positionspreisen berechnete Liga-Obergrenze begrenzt. Bei bereits vollständig ausgegebenem Budget erfolgt eine Umschichtung ausschließlich als gekoppelter, kostenneutraler Bank-zu-Startelf-Tausch; das Ziel darf niemals durch Restbudget erkauft werden.
