...
- Eine unvollständige neue Saison mit weniger als 35 Prozent Stichprobenkonfidenz und weniger als 600 Minuten nicht als jüngste belastbare Formperiode verwenden. Bei Spielern ab 30 die letzten zwei belastbaren Spielzeiten zusätzlich mit der älteren Basis vergleichen. Liegen sie mindestens fünf Punkte darunter und ist der Einbruch kein belegter Verletzungs-/Rückkehrfall, `confirmed_performance`, `minutes` und `role` auf die jüngere Basis plus einen altersabhängig kleinen Erfahrungsaufschlag deckeln. Alter allein erzeugt keinen Abschlag.
...
- Saisonminuten sind nur der Fallback für die aktuelle Einsatzprognose. Belegte jüngste Pflichtspielstarts und direkte Trainerentscheidungen zwischen Positionskonkurrenten besitzen Vorrang; eine nachweisliche Bevorzugung des Konkurrenten in entscheidenden Rückrunden- oder K.-o.-Spielen deckelt die Startwahrscheinlichkeit auch bei ähnlichen Saisonminuten.
...
- Bei unverändertem Verein die erwartete Startwahrscheinlichkeit an der jüngsten belastbaren Ligasaison kalibrieren. Kapitänsamt, Vertragsverlängerung und ein einzelner Vorbereitungseinsatz bestätigen keine dauerhafte Startelfrolle. Nur eine aktuelle ausdrückliche Festlegung als erste Wahl, Nummer eins oder Stammspieler darf die Startquotenobergrenze überstimmen. Bei einem Vereinswechsel stattdessen die belegte neue Rolle bewerten.
...
- Leihen mit dem `loan_pathway_profile` bewerten. Eine bestätigte Leihe kann bei U23-Spielern Potenzial und Preis-Leistung begrenzt erhöhen, wenn frühe Herrenminuten, herausragende unterklassige Leistung, tatsächliche höherklassige Profiminuten oder eine belegte Zielvereinsrolle hinzukommen. Das Niveau des Stammvereins ist nur ein kleiner bestätigender Ausbildungs- und Selektionshinweis. Ein Premier-League-Vertrag ohne Premier-League-Minuten darf nicht wie bewiesenes Premier-League-Niveau zählen; tatsächliche Seniorenminuten in dieser Liga werden dagegen über den historischen Ligastärkepfad berücksichtigt.
...
- Zwei qualifizierte U23-Potenzialspieler im erweiterten Kern weich anstreben, aber keine Altersquote erzwingen. Ein Potenzialspieler zählt als qualitätsnaher Startelfkandidat, wenn sein Score höchstens sieben Punkte und sieben Prozent hinter dem besten finanziell vergleichbaren Positionsspieler liegt. Günstige Talente nur gegen erschwingliche Peers vergleichen.
...
- Der nach Modellscore erste Mittelfeldersatz muss mindestens `minutes 60`, `role 60`, `fitness 65` und höchstens 45 bei Transfer-, Verletzungs-, Rotations- und Rollenrisiko erreichen, sofern der vollständig annotierte Pool mindestens eine solche Option enthält. Eine nominell breite, aber nicht direkt einsetzbare Mittelfeldbank ist kein Ersatz für Spielbarkeit.
- Formationsflexibilität allein rechtfertigt keinen bezahlten Reservisten. Er benötigt zusätzlich mindestens 60 Prozent belegte Startwahrscheinlichkeit, ausreichende Fitness und vertretbare Transfer-, Verletzungs-, Rotations- und Rollenrisiken oder muss als qualifizierter Potenzialspieler gelten.
...
- Im Profil `verlässlich` mindestens einen offensiven Premiumanker in dieser Startelf verlangen. Ihn positionsneutral innerhalb von Mittelfeld und Sturm aus zwei getrennten Gates ableiten: (1) mehrjährige bestätigte Leistung, Stabilität und aktuelle Einsatzsicherheit als verlässliches Fundament und (2) mindestens `4,0` Punkte `starting_scorer_leverage` als belegten Offensivpfad. Dieser zweite Pfad entsteht nur aus wiederholbarer, ligagewichteter Tor-/Vorlagenproduktion und/oder aktuell bestätigten Elfmetern, direkten Freistößen, Ecken, Spielmacher- oder offensiven Fokusaufgaben. Hohe Minuten, allgemeine Rolle, Kapitänsamt oder defensive Zuverlässigkeit allein reichen nicht. Weder `benchmark`, Bekanntheit noch eine frühere Nennung durch den Nutzer dürfen diesen Status erzeugen. Für das zusätzliche Premiumstarter-Gate zählt nur ein echter Topscorer aus der oberen Preis- und Leistungsgruppe: mindestens drei bestätigte Spielzeiten, mindestens 1.200 belastbare Minuten im Scorerprofil, mindestens 0,35 Tore oder 0,60 Torbeteiligungen pro 90 Minuten sowie ein aktuell nutzbarer Scorerhebel. Ein reiner Standard- oder Spielmacheranker ohne diesen Produktionspfad erfüllt das Gate nicht.
- Bei geringem Betreuungsaufwand muss mindestens ein Topscorer der höchsten aktuellen ligaweiten Produktionsstufe im Kern stehen, sofern der belegte Pool eine solche Stufe enthält. Die Stufe wird relativ aus aktuellem Scorerhebel sowie Tor- und Torbeteiligungsrate bestimmt. Dadurch kann ein guter Value-Scorer nicht stellvertretend den Platz eines klar stärkeren Kane-/Olise-Typs erfüllen; konkrete Namen bleiben ohne Bonus.
...
- Bei `gering` höchstens einen Reserveangreifer oberhalb des positionsbezogenen Mindestpreises zulassen, seinen Preis auf höchstens 0,10 Mio. über diesem Mindestpreis begrenzen und mindestens 75 Prozent des Sturmbudgets in den höchstens drei startenden Angreifern verlangen. Jeder bezahlte vierte oder fünfte Stürmer setzt einen direkt einsetzbaren ersten Abwehr- und Mittelfeldersatz voraus und muss Billigstürmer-plus-Upgrade-Pakete über beide Positionen schlagen. Das ist ein hartes `forward_reserve_architecture`-Gate; eine nur vollständig ausgeführte Grenznutzensuche genügt nicht.
- Jeden Feldreservisten oberhalb des Positionsmindestpreises zusätzlich im `paid_reserve_justification`-Gate prüfen. Er benötigt entweder mindestens 75 Prozent kalibrierte Startwahrscheinlichkeit plus wenigstens 78 Prozent Startquote der letzten belastbaren Ligasaison und aktuelle Form, einen qualitätsnahen Potenzialpfad oder einen im Verhältnis zum Aufpreis ausreichenden Beitrag zu einer nahen Alternativformation. Eine ausdrückliche aktuelle Stammspielerfestlegung kann die historische Startquote ersetzen.
...
|---|---:|---:|
| niedrig | höchstens 2,5 % | genau 3 Spieler, sofern im Korridor machbar |
| mittel | höchstens 7 % | genau 5 Spieler, sofern im Korridor machbar |
| hoch | höchstens 10 % | genau 8 Spieler, sofern im Korridor machbar |

- Eine nachgelagerte Kern-, Budget- oder Torwarthierarchie-Reparatur darf den Zielunterschied um genau einen Spieler unter- oder überschreiten. Damit gelten nach allen harten Regeln 2–4, 4–6 beziehungsweise 7–9 Spieler als enge zulässige Toleranz; größere Abweichungen bleiben eine Warnung.
- Beim Profil `verlässlich` die ausgewiesene Qualitätsgrenze vollständig nutzen, aber sämtliche Rollen-, Minuten-, Fitness- und Architekturhürden unverändert beibehalten. Verlässlichkeit entsteht durch diese harten Evidenzregeln, nicht durch nahezu identische Namen.
...
- Die letzten fünf abgeschlossenen lokalen Varianten desselben Kontexts als Expositionshistorie verwenden. Innerhalb des engen Qualitätskorridors wiederholt ausgewählte gewöhnliche Spieler zunehmend abwerten; Spieler aus dem sportlichen Kern stärker als günstige Bankplätze belasten und diese Abwertung bis durch die finale Architektursearch erhalten. Nur evidenzbasiert nicht gleichwertig ersetzbare Ausnahmespieler schützen. Eine neue Variante soll dadurch andere Rollenäquivalente wählen und nicht bloß billige Bankplätze austauschen.
- Nach der vollständigen Finalisierung muss der Mindestabstand zu jeder jüngsten abgeschlossenen Variante bei `niedrig`, `mittel` und `hoch` mindestens 2, 4 beziehungsweise 7 Spieler betragen. Das entspricht der unteren Grenze der zulässigen finalen Toleranz und ist eine harte Suchbedingung; ist sie im Qualitätskorridor mit den geschützten echten Premiumankern nicht erreichbar, darf das Ergebnis nicht als erfolgreich neue Variante bezeichnet werden.
...
- Beim Profil `verlässlich` und geringem Betreuungsaufwand im erweiterten Kern zwei qualifizierte U23-Potenzialspieler oberhalb des Minimalpreises weich anstreben, sofern ligaweit geeignete Kandidaten verfügbar sind. Talentwert, Herrenreife, Einsatzprognose, Rolle, Fitness und der höchstens siebenprozentige Abstand zu erschwinglichen Positionsalternativen müssen gemeinsam tragen; keine pauschale Altersquote verwenden. Eine Startelf über 28 Jahre oder ohne U23-Spieler als prüfbare Warnung ausgeben, nicht automatisch verwerfen.
