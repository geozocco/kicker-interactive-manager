...
- Die Abwehr besitzt zusätzlich eine harte Spielbarkeitsuntergrenze. Bei sieben Kaderplätzen höchstens vier Verteidiger zum aktuellen positionsbezogenen Mindestpreis und höchstens einen davon in der Startelf zulassen. Von den startenden Verteidigern müssen alle bis auf höchstens einen mindestens `minutes 65`, `role 65`, `fitness 65`, `transfer 45`, `injury 45`, `rotation 40` und `unknown_role 40` erfüllen. Ein günstiger qualifizierter Potenzialspieler kann diese Schwelle über seine tatsächlichen Rollen- und Bereitschaftswerte erfüllen; Alter oder Preis allein genügen nicht.
- Abwehrpakete mit derselben vollständigen Positionssuche wie Mittelfeld und Sturm prüfen. Startet die Optimierung mit einer unzulässigen Mindestpreisstruktur, ausschließlich Tausche akzeptieren, die die Zahl harter Verstöße schrittweise senken, bis ein gültiger Kader erreicht ist. Einen weiterhin ungültigen Ausgangskader niemals nur mit Warnung veröffentlichen.
