...
- `loan_pathway` hält bei bestätigten Leihen Dealtyp, Leihzweck, Stammvereinsniveau, stärkstes tatsächlich gespieltes Seniorenniveau, höherklassige Seniorenminuten, unabhängiges Leistungssignal und begrenzte Minuten-, Rollen-, Value- und Upside-Anpassungen getrennt fest. `qualified_potential` darf niemals allein durch den Stammverein entstehen.
