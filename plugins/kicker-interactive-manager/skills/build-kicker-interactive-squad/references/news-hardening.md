...
Der Transfer-Watcher deckt alle verfügbaren Marktspieler ab, recherchiert aber veränderungs- und risikobasiert. Neue Spieler, bestehende Transfermeldungen, hohe Transferrisiken und offene Rollenfälle werden zuerst behandelt. Spieler mit bereits konkretem Transfersignal, offenem Konkurrenzfall, mindestens 50 Punkten Transferrisiko oder hohem Risiko einer externen Neuverpflichtung laufen jeweils in einer eigenen Web-Search-Anfrage, damit eine konkrete Meldung nicht im Suchbudget eines Mehrspieler-Batches untergeht. Bleibt ein kritischer Einzellauf leer, folgt automatisch eine zweite Anfrage mit anderen Suchformulierungen und möglichst zwei unabhängigen Domains. Bloß neue beziehungsweise bislang unbewertete Marktspieler behalten zwar hohe Priorität, bleiben ohne ein solches Risikosignal aber aus Kosten- und Laufzeitgründen gebündelt. Ein frisches Rollenprofil `open_competition` und ein glaubhaftes Risiko einer externen Neuverpflichtung erhöhen die Transferpriorität ausdrücklich. Belegte Meldungen bleiben bewusst kurz gecacht: fortgeschrittene beziehungsweise bestätigte Vorgänge sechs Stunden, übrige Gerüchte zwölf Stunden. Ein zweimal belegtes „keine aktuelle Meldung“ wird bei kritischen Spielern zwei Stunden, bei erhöhtem Risiko 24 Stunden und bei unauffälligen Spielern 72 Stunden gecacht. Ein Wechsel von Name, Verein oder Position erzwingt unabhängig davon eine neue Prüfung. `urgent` hält noch gültige Routinebelege bis zum Standardlauf fest und vermeidet ihre erneute Websuche. Das Modell entdeckt und extrahiert Quellen; Status, Richtung, Ausschlusswirkung und Konfliktbehandlung bleiben deterministisch. Eine ältere Station, die weder den aktuellen Kicker-Verein als Quelle noch als Ziel nennt, wird verworfen. Bei verketteten Wechseln zählt der neueste Schritt, beispielsweise erst der feste Wechsel zum Stammverein und anschließend die Leihe zum aktuellen Kicker-Verein. Bei Leihen werden zusätzlich Stammverein, Dealtyp, Leihzweck und das Niveau der aktuellen Seniorenliga des Stammvereins erfasst. Prestige allein erzeugt dabei keinen Leistungsnachweis.
